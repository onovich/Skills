...
- `bilingual-readme-generator`: Formats repository documentation into a compact, professional English/Chinese dual-language layout using strict inline `<br/>` translation rules.<br/>**`bilingual-readme-generator`: 将仓库文档格式化为紧凑、专业的英/中双语布局，使用严格的 `<br/>` 行内翻译规则。**
